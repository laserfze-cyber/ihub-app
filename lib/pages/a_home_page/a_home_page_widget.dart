        ...
        body: Container(
          decoration: BoxDecoration(
            image: DecorationImage(
              fit: BoxFit.cover,
              image: Image.asset(
                'assets/images/start_page_with_map.png',
              ).image,
            ),
          ),
          child: Stack(
                  ...
                  children: [
                    Padding(
                      ...
                      child: Stack(
                        children: [
                          Align(
                            alignment: AlignmentDirectional(-0.23, -0.58),
                            child: Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  0.0, 0.0, 45.0, 0.0),
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  'esjbhaj8' /* Welcome to the
    Car Recover... */
                                  ,
                                ),
                                      ...
                                      text: TextSpan(
                                        children: [
                                          TextSpan(
                                            text: FFLocalizations.of(context)
                                                .getText(
                                              '2q0ki7fb' /* • Request car recovery or towi... */,
                                            ),
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
                                      ...
                                      text: TextSpan(
                                        children: [
                                          TextSpan(
                                            text: FFLocalizations.of(context)
                                                .getText(
                                              'yvz6u5fg' /* • Track your car fleet and fam... */,
                                            ),
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
                                      ...
                                      text: TextSpan(
                                        children: [
                                          TextSpan(
                                            text: FFLocalizations.of(context)
                                                .getText(
                                              'rpup4o4s' /* • Monitor your children and pe... */,
                                            ),
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
