...
import 'f_settings_model.dart';
export 'f_settings_model.dart';

class FSettingsWidget extends StatefulWidget {
  const FSettingsWidget({super.key});

  static String routeName = 'F-Settings';
  static String routePath = '/fSettings';

  @override
  State<FSettingsWidget> createState() => _FSettingsWidgetState();
}

class _FSettingsWidgetState extends State<FSettingsWidget> {
  late FSettingsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FSettingsModel());
            ...
            children: [
              ...
              Padding(
                ...
                child: FlutterFlowDropDown<String>(
                  controller: _model.textFieldcountryValueController ??=
                      FormFieldController<String>(
                    _model.textFieldcountryValue ??= FFAppState().Appcountry,
                  ),
                  options: functions.getCountryList(),
                  onChanged: (val) async {
                    safeSetState(() => _model.textFieldcountryValue = val);
                    FFAppState().Appcountry = _model.textFieldcountryValue!;
                    safeSetState(() {});
                  },
                  width: 319.0,
                  height: 40.0,
                  maxHeight: 400.0,
                  menuOffset: Offset(400.0, 400.0),
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Text(
                            FFLocalizations.of(context).getText(
                              '7snzztny' /* Deleting your account will per... */,
                            ),
                            style: FlutterFlowTheme.of(context)
                                .bodyMedium
                                .override(
                            ...
                            child: Container(
                              ...
                              child: StreamBuilder<List<LoginRecord>>(
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  List<LoginRecord> rowLoginRecordList =
                                      snapshot.data!;
                                        ...
                                        child: FFButtonWidget(
                                          onPressed: () async {
                                            ...
                                            if (confirmDialogResponse) {
                                              await rowLoginRecord!.reference
                                                  .delete();
                                              await authManager
                                                  .deleteUser(context);
                                              await showDialog(
