...
import '/components/taxi_order_widget.dart';
...
import 'q1_taxi_driver_page_model.dart';
export 'q1_taxi_driver_page_model.dart';

class Q1TaxiDriverPageWidget extends StatefulWidget {
  const Q1TaxiDriverPageWidget({super.key});

  static String routeName = 'Q1-Taxi-driver_page';
  static String routePath = '/q1TaxiDriverPage';

  @override
  State<Q1TaxiDriverPageWidget> createState() => _Q1TaxiDriverPageWidgetState();
}

class _Q1TaxiDriverPageWidgetState extends State<Q1TaxiDriverPageWidget>
    with TickerProviderStateMixin {
  late Q1TaxiDriverPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Q1TaxiDriverPageModel());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<LoginRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<LoginRecord> q1TaxiDriverPageLoginRecordList = snapshot.data!;
                                            ...
                                            child: FlutterFlowGoogleMap(
                                              ...
                                              initialLocation:
                                                  _model.googleMapsCenter ??=
                                                      currentUserLocationValue!,
                                              markers:
                                                  q1TaxiDriverPageLoginRecordList
                                                      .map(
                                                        (marker) =>
                                                            FlutterFlowMarker(
                                              ...
                                              markerImage: MarkerImage(
                                                imagePath:
                                                    'assets/images/emergency_lift_2.png',
                                                isAssetImage: true,
                                                size: 30.0 ?? 20,
                                              ),
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              children: [
                                                                                ...
                                                                                FFButtonWidget(
                                                                                  ...
                                                                                  text: FFLocalizations.of(context).getText(
                                                                                    'lvf3daj0' /* A new order is coming. */,
                                                                                  ),
                                                                                  options: FFButtonOptions(
                                                                                    height: 40.0,
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              child: FFButtonWidget(
                                                                                onPressed: () async {
                                                                                  ...
                                                                                  await containerRideRequestsRecord!.reference.update(createRideRequestsRecordData(
                                                                                    status: 'accepted',
                                                                                    ...
                                                                                    ourBenefit: FFAppState().ourbenifit,
