...
import 'd_driver_page_model.dart';
export 'd_driver_page_model.dart';

class DDriverPageWidget extends StatefulWidget {
  const DDriverPageWidget({super.key});

  static String routeName = 'D-Driver-page';
  static String routePath = '/dDriverPage';

  @override
  State<DDriverPageWidget> createState() => _DDriverPageWidgetState();
}

class _DDriverPageWidgetState extends State<DDriverPageWidget> {
  late DDriverPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DDriverPageModel());
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Padding(
                                        ...
                                        child: Text(
                                          FFLocalizations.of(context).getText(
                                            '9a7xd80j' /* Stop Sharing Location */,
                                          ),
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
                                              .override(
                                      ...
                                      children: [
                                        StreamBuilder<List<LoginRecord>>(
                                          ...
                                          builder: (context, snapshot) {
                                            ...
                                            List<LoginRecord>
                                                switchLoginRecordList =
                                                snapshot.data!;
                                            // Return an empty Container when the item does not exist.
                                            if (snapshot.data!.isEmpty) {
                                              return Container();
                                            }
                                            final switchLoginRecord =
                                                switchLoginRecordList.isNotEmpty
                                                    ? switchLoginRecordList
                                                        .first
                                                    : null;
                                          ...
                                          child: Align(
                                            ...
                                            child: Text(
                                              FFLocalizations.of(context)
                                                  .getText(
                                                'g7b2m9dq' /* This button is only active for... */,
                                              ),
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .bodyMedium
                                          ...
                                          builder: (context) =>
                                            ...
                                            builder: (context, snapshot) {
                                              ...
                                              List<LoginRecord>
                                                  rowLoginRecordList =
                                                  snapshot.data!;
                                              final rowLoginRecord =
                                                  rowLoginRecordList.isNotEmpty
                                                      ? rowLoginRecordList.first
                                                      : null;
