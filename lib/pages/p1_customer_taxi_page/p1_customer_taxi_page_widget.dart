...
import '/components/nobody_taxi_taketheorder_widget.dart';
...
import 'p1_customer_taxi_page_model.dart';
export 'p1_customer_taxi_page_model.dart';

class P1CustomerTaxiPageWidget extends StatefulWidget {
  const P1CustomerTaxiPageWidget({super.key});

  static String routeName = 'P1-Customer--Taxi-Page';
  static String routePath = '/p1CustomerTaxiPage';

  @override
  State<P1CustomerTaxiPageWidget> createState() =>
      _P1CustomerTaxiPageWidgetState();
}

class _P1CustomerTaxiPageWidgetState extends State<P1CustomerTaxiPageWidget>
    with TickerProviderStateMixin {
  late P1CustomerTaxiPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => P1CustomerTaxiPageModel());
            ...
            return Dialog(
              ...
              child: GestureDetector(
                ...
                child: Container(
                  height: 400.0,
                  width: 400.0,
                  child: NobodyTaxiTaketheorderWidget(),
                ),
              ),
            );
          },
      ...
      builder: (context) => StreamBuilder<List<LoginRecord>>(
        stream: queryLoginRecord(
          queryBuilder: (loginRecord) => loginRecord
            ...
            List<LoginRecord> p1CustomerTaxiPageLoginRecordList = snapshot;
            if (_model.p1CustomerTaxiPagePreviousSnapshot != null &&
                !const ListEquality(LoginRecordDocumentEquality()).equals(
                    p1CustomerTaxiPageLoginRecordList,
                    _model.p1CustomerTaxiPagePreviousSnapshot)) {
              () async {
            ...
            _model.p1CustomerTaxiPagePreviousSnapshot = snapshot;
          }),
        builder: (context, snapshot) {
          ...
          List<LoginRecord> p1CustomerTaxiPageLoginRecordList = snapshot.data!;
