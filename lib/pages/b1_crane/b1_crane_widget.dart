...
import 'b1_crane_model.dart';
export 'b1_crane_model.dart';

class B1CraneWidget extends StatefulWidget {
  const B1CraneWidget({super.key});

  static String routeName = 'B1-Crane';
  static String routePath = '/b1Crane';

  @override
  State<B1CraneWidget> createState() => _B1CraneWidgetState();
}

class _B1CraneWidgetState extends State<B1CraneWidget>
    with TickerProviderStateMixin {
  late B1CraneModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => B1CraneModel());
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          image: DecorationImage(
                            ...
                            alignment: AlignmentDirectional(0.0, 0.0),
                            image: Image.asset(
                              'assets/images/AIEnhancer_Crane_Image_Effect_prompt_Crea.png',
                            ).image,
                          ),
                        ),
                      ),
                          ...
                          children: [
                            Align(
                              ...
                              child: Padding(
                                ...
                                child: Text(
                                  FFLocalizations.of(context).getText(
                                    '0lfizkg7' /* Book a Crane ride here. */,
                                  ),
                                  style: FlutterFlowTheme.of(context)
                                      .bodyMedium
                                      .override(
                            ...
                            child: RichText(
                              ...
                              text: TextSpan(
                                children: [
                                  TextSpan(
                                    text: FFLocalizations.of(context).getText(
                                      '9fpd25hi' /* Please select a country in Set... */,
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
